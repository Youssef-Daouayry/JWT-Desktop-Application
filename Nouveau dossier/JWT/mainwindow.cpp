...
void MainWindow::on_verificationBtn_clicked()
{
    ...
    if (parts.size() != 3) {
        ...
        ui->verificationLabel->setText("Invalid token");
    ...
    if (selectedAlgorithm == "HS256") {
        ...
        if (calculatedSignature == providedSignature) {
            ui->verificationLabel->setText("Valid signature");
